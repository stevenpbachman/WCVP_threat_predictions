...
home_dir <- getwd()
model_dir <- file.path(home_dir,"output/review1/latest_bart_rl2022_1/")
...
ggsave("05_results/bart-performance-disaggregated-climate.svg", perf_plots_climate, height=10, width=7)
...
perf_plots_zone <- (((lifeform_perf_plot + labs(x="")) / 
  ...
  theme(legend.position="bottom", 
        ...
        text=element_text(family="DejaVu Sans")) &
  guides(fill="none", colour=guide_legend(title=""))
ggsave("05_results/bart-performance-disaggregated-zones.svg", perf_plots_zone, height=10, width=7)
...
ggsave("05_results/bart-performance-maps-vertical.svg", vertical,
       height=9, width=6)
...
ggsave("05_results/bart-feature-importance-full.svg", full_importance_plot, height=10, width=6)
...
ggsave("05_results/bart-feature-importance-grouped.svg", grouped_importance_plot, height=3, width=6)
...
ggsave("05_results/bart-senitivity-range.svg", sensitivity_vs_range, height=3, width=6)
...
ggsave("05_results/bart-criteria-performance.svg", criteria_plot, height=3, width=6)
...
ggsave("05_results/bart-b-criterion-performance.svg", b_criteria_plot, height=3, width=6)
...
ggsave("05_results/bart-threat-comparison.svg", threat_comparison, height=3, width=6)
...
ggsave("05_results/bart-predictions-disaggregated-climate.svg", pred_plot_climate, height=10, width=7)
...
ggsave("05_results/bart-predictions-disaggregated-zones.svg", pred_plot_zones, height=10, width=7)
...
ggsave("05_results/bart-prediction-map.svg", pred_map, height=5, width=10)
...
write_csv(species_probs, "05_results/bart-species-probabilities.csv")